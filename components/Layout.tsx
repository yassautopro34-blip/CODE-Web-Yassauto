          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="text-sm md:text-base font-bold text-black">
                <span>Étudiant(e) ? Profite de -30% sur l'accompagnement achat (100€ au lieu de 150€)</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                onClick={() => {
                  ...
                  try { localStorage.setItem('studentBannerHidden', '1'); } catch (e) {}
                }}
            ...
            <div>
              ...
              <ul className="space-y-2 text-zinc-400 text-sm">
                ...
                <li className="flex space-x-4 mt-4">
                    ...
                    <a href="https://www.tiktok.com/@yass.auto.pro?_r=1&_t=ZN-91rLyuryMFP" className="w-10 h-10 bg-zinc-800 rounded-lg flex items-center justify-center text-white hover:bg-brand-red hover:text-white transition-all duration-300">
                      <Video className="w-5 h-5" />
                    </a>
                    <a href="https://www.facebook.com/share/17kdB2B3po/?mibextid=wwXIfr" className="w-10 h-10 bg-zinc-800 rounded-lg flex items-center justify-center text-white hover:bg-brand-red hover:text-white transition-all duration-300">
